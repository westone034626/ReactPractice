    ...
    <div className={styles.body}>
      <header className="header">
        <div className="globalWidth">
          <h1 className="pageTitle">코로나19 시대, 제주 사는 개발자의 하루</h1>
          <p>
      ...
      <section className="scrollContent">
        <div className="scrollGraphic">
          <div className="graphicItem">
            <img className="sceneImg" src="images/00.png" alt="" />
          </div>
          <div className="graphicItem">
            <img className="sceneImg" src="images/01.png" alt="" />
          </div>
          <div className="graphicItem" data-action="birdFlies">
            <img className="sceneImg" src="images/02.png" alt="" />
          </div>
          <div className="graphicItem">
            <img className="sceneImg" src="images/bird.gif" alt="" />
          </div>
          <div className="graphicItem">
            <img className="sceneImg" src="images/03.png" alt="" />
          </div>
          <div className="graphicItem" data-action="birdFlies2">
            <img className="sceneImg" src="images/04.png" alt="" />
          </div>
          <div className="graphicItem">
            <img className="sceneImg" src="images/05.png" alt="" />
          </div>
          <div className="graphicItem">
            <img className="sceneImg" src="images/06.png" alt="" />
          </div>
          <div className="graphicItem">
            <img className="sceneImg" src="images/07.png" alt="" />
          </div>
          <div className="graphicItem">
            <img className="sceneImg" src="images/08.png" alt="" />
          </div>
        </div>
      ...
      <section className="normalContent globalWidth">
        <h2>도시를 떠나는 사람들</h2>
        <p>
