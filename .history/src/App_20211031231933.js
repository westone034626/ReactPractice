      ...
      <section className="scroll-content">
        <div className="scroll-graphic">
          <div className="graphic-item">
            <img className="scene-img" src="images/00.png" alt="" />
          </div>
          <div className="graphic-item">
            <img className="scene-img" src="images/01.png" alt="" />
          </div>
          <div className="graphic-item" data-action="birdFlies">
            <img className="scene-img" src="images/02.png" alt="" />
          </div>
          <div className="graphic-item">
            <img className="scene-img" src="images/bird.gif" alt="" />
          </div>
          <div className="graphic-item">
            <img className="scene-img" src="images/03.png" alt="" />
          </div>
          <div className="graphic-item" data-action="birdFlies2">
            <img className="scene-img" src="images/04.png" alt="" />
          </div>
          <div className="graphic-item">
            <img className="scene-img" src="images/05.png" alt="" />
          </div>
          <div className="graphic-item">
            <img className="scene-img" src="images/06.png" alt="" />
          </div>
          <div className="graphic-item">
            <img className="scene-img" src="images/07.png" alt="" />
          </div>
          <div className="graphic-item">
            <img className="scene-img" src="images/08.png" alt="" />
          </div>
        </div>
