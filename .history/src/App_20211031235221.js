    ...
    <div className={styles.body}>
      ...
      <div className={styles.scrollContent}>
        <div className={styles.scrollGraphic}>
          {graphicItems.map((graphicItem) => (

          <div className={styles.graphicItem}>
            <img className={styles.sceneImg} src=`img/${graphicItem.imageFileName}` alt="" />
          </div>
          ))}
          <div className={styles.graphicItem}>
            <img className={styles.sceneImg} src="img/00.png" alt="" />
          </div>
          <div className={styles.graphicItem}>
            <img className={styles.sceneImg} src="img/01.png" alt="" />
          </div>
          <div className={styles.graphicItem} data-action="birdFlies">
            <img className={styles.sceneImg} src="img/02.png" alt="" />
          </div>
          <div className={styles.graphicItem}>
            <img className={styles.sceneImg} src="img/bird.gif" alt="" />
          </div>
          <div className={styles.graphicItem}>
            <img className={styles.sceneImg} src="img/03.png" alt="" />
          </div>
          <div className={styles.graphicItem} data-action="birdFlies2">
            <img className={styles.sceneImg} src="img/04.png" alt="" />
          </div>
          <div className={styles.graphicItem}>
            <img className={styles.sceneImg} src="img/05.png" alt="" />
          </div>
          <div className={styles.graphicItem}>
            <img className={styles.sceneImg} src="img/06.png" alt="" />
          </div>
          <div className={styles.graphicItem}>
            <img className={styles.sceneImg} src="img/07.png" alt="" />
          </div>
          <div className={styles.graphicItem}>
            <img className={styles.sceneImg} src="img/08.png" alt="" />
          </div>
        </div>
        <div className={`${styles.scrollText} ${styles.globalWidth}`}>
          ...
          <div className={styles.step}>
            <p style={{ whiteSpace: 'pre-line' }}>{`맞다, 트위터의 걔.`}</p>
          </div>
          <div className={styles.step}>
            <p
              style={{ whiteSpace: 'pre-line' }}
            >{`운동을 마치고 집에 돌아와 작업을 시작한다.`}</p>
          </div>
          <div className={styles.step}>
            <p style={{ whiteSpace: 'pre-line' }}>
              {`밥은 집에서 먹거나, 테이크아웃이 가능한 메뉴를 골라 탁 트인
              야외에서 먹는다. 물론 사회적 거리두기를 하기 위함이다.
          `}
            </p>
          </div>
