      ...
      <section className="scrollContent">
        <div className="scrollGraphic">
          <div className="graphicItem">
            <img className="sceneImg" src="img/00.png" alt="" />
          </div>
          <div className="graphicItem">
            <img className="sceneImg" src="img/01.png" alt="" />
          </div>
          <div className="graphicItem" data-action="birdFlies">
            <img className="sceneImg" src="img/02.png" alt="" />
          </div>
          <div className="graphicItem">
            <img className="sceneImg" src="img/bird.gif" alt="" />
          </div>
          <div className="graphicItem">
            <img className="sceneImg" src="img/03.png" alt="" />
          </div>
          <div className="graphicItem" data-action="birdFlies2">
            <img className="sceneImg" src="img/04.png" alt="" />
          </div>
          <div className="graphicItem">
            <img className="sceneImg" src="img/05.png" alt="" />
          </div>
          <div className="graphicItem">
            <img className="sceneImg" src="img/06.png" alt="" />
          </div>
          <div className="graphicItem">
            <img className="sceneImg" src="img/07.png" alt="" />
          </div>
          <div className="graphicItem">
            <img className="sceneImg" src="img/08.png" alt="" />
          </div>
        </div>
